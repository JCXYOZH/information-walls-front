  ...
  <div class="register">
    ...
    >
      ...
      <el-form-item style="width: 100%">
        ...
        <el-checkbox v-model="registerForm.agree" required>
          我已阅读并同意
          <router-link to="/userAgree" style="color: blue;">用户协议</router-link>
        </el-checkbox>
      </el-form-item>
    </el-form>
    <!--  底部  -->
    <div class="el-register-footer">
      <span>Copyright © 2025 lzh.com All Rights Reserved.</span>
    </div>
  </div>
</template>
<script>
